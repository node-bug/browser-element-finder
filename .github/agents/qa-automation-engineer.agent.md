...
- `node_modules/@nodebug/selenium/docs/CONCEPTS.md` - Intermediate vs terminal operations, element location strategy
- `node_modules/@nodebug/selenium/docs/API-REFERENCE.md` - Complete WebBrowser API reference
- `node_modules/@nodebug/selenium/docs/CONFIGURATION.md` - Browser configuration options
- `node_modules/@nodebug/selenium/README.md` - Quick start and core patterns
- `tests/` - Existing test examples for patterns and conventions
- `node_modules/@nodebug/selenium/docs/spatial-references.md` - Position-based element selection
- `node_modules/@nodebug/selenium/docs/element-types.md` - Semantic element type guidance

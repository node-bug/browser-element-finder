  ...
  describe('findElementByAttributes', () => {
    it('should find elements matching visible text "Home"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Home');
      `);
    ...
    it('should find elements matching "Heading 1"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Heading 1');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should find elements matching "Standard Button"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Standard Button');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should find elements by id attribute', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('btn-standard');
      `);
    ...
    it('should find elements by aria-label attribute', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Role Image');
      `);
      const mainElements = result.elements.filter(e => e.element);
      expect(mainElements.length).toBe(1);
      const id = await mainElements[0].element.getAttribute('id');
    ...
    it('should find elements by alt attribute', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Test Image');
      `);
      const mainElements = result.elements.filter(e => e.element);
      expect(mainElements.length).toBe(1);
      const id = await mainElements[0].element.getAttribute('id');
    ...
    it('should find elements by role attribute', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('navigation');
      `);
      const mainElements = result.elements.filter(e => e.element);
      expect(mainElements.length).toBe(1);
    });
    ...
    it('should find elements matching "Role Button"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Role Button');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should find elements matching "Role Switch"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Role Switch');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should find elements matching "Role Radio"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Role Radio');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should find elements matching "Combobox"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Combobox');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should find elements matching "Role Textbox"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Role Textbox');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should find elements matching "Role List Item"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Role List Item');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should find elements matching "Role Menu Item"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Role Menu Item');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should find elements matching "Role Heading"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Role Heading');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should find elements matching "Dialog content"', async () => {
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Dialog content');
      `);
      expect(result.elements.length).toBe(1);
    });
    ...
    it('should support exact matching for attributes', async () => {
      ...
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Standard Button', true);
      `);
      expect(result.elements.length).toBe(1);

      // Partial match should not find with exact=true
      const result2 = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Standard', true);
      `);
      ...
      const result3 = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Standard', false);
      `);
    ...
    it('should support exact matching for text content', async () => {
      ...
      const result = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Heading 1', true);
      `);
      expect(result.elements.length).toBe(1);

      // Partial match should not find with exact=true
      const result2 = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Heading', true);
      `);
      expect(result2.elements.length).toBe(0);

      // Partial match should find with exact=false (default)
      const result3 = await driver.executeScript(`
        return ElementFinderByAttribute.findElementByAttributes('Heading', false);
      `);
      expect(result3.elements.length).toBeGreaterThan(0);
    });
  });
